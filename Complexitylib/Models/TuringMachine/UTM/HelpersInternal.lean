...
-- ════════════════════════════════════════════════════════════════════════
-- Tape helpers (public — shared across UTM proof modules)
-- ════════════════════════════════════════════════════════════════════════
...
/-- writeAndMove with readBackWrite/idleDir is identity when read ≠ ▷ and head ≥ 1. -/
theorem tape_idle_preserve (t : Tape) (hns : t.read ≠ Γ.start) (hh : t.head ≥ 1) :
...
/-- Rich HoareTime for `rewindWorkTM` that preserves an arbitrary predicate P
    ...
    tape. This is the key tool for threading data (descOnTape, stateOnTapeAt,
