...
/-!
# Sequential function-composition correctness — proof internals

This module connects the first computation's placed raw-output boundary to the
normalization tail and derives the coarse monotone time bound used for `FP`.
-/
